data = read.csv('E:/R prog/archive/DailyDelhiClimateTrain.csv')
data
head(data)
...
#From the PACF we can say that p=2 and q=2, though there is no trend we can observe a seasonal component in the humidity.
